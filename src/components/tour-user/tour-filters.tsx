...
export function TourFilters({ className }: TourFiltersProps) {
  ...
  const [province, setProvince] = useState<string | undefined>(searchParams.get("province") || undefined)
  ...
  const [duration, setDuration] = useState<string | undefined>(searchParams.get("duration") || undefined)
  ...
  useEffect(() => {
    ...
    const urlMinPrice = searchParams.get("minPrice") ? parseInt(searchParams.get("minPrice")!) : 0
    const urlMaxPrice = searchParams.get("maxPrice") ? parseInt(searchParams.get("maxPrice")!) : 1000
